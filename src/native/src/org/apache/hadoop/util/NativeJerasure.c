...
/* Added by RH Dec 26th 2014 begins */
int *matrix = NULL;
/* Added by RH Dec 26th 2014 ends */
...
JNIEXPORT void JNICALL Java_org_apache_hadoop_util_NativeJerasure_nativeDecodeBulk
  ...
  for (i = 0; i < stripeSize + paritySize; i++) {
    ...
    if (i < paritySize) {
      ...
      /* fixed by RH Jan 2nd 2015 begins */
      //coding[paritySize-1-i] = (char*)(*env)->GetDirectBufferAddress(env, j_inputBuffer);
      /* fixed by RH Jan 2nd 2015 ends */
    } else {
