...
public class SumJob extends Configured implements Tool  {
  ...
  static final Path TMP_DIR = new Path("raidTest");
  ...
  public int run (String args[]) throws Exception {
    ...
    //final Path inFile = new Path(otherArgs[0]);
    /* Modified by RH Jan 28th 2015 ends */
    ...
    final Path outDir = new Path("sumOut");
    if (fs.exists(outDir)) {
