...
public class BlockPlacementPolicyStair extends BlockPlacementPolicyRaid {
  ...
  BlockPlacementPolicyStair(Configuration conf,
  ...
  public void initialize(Configuration conf,
    ...
    LOG.info("R-STAIR code placement initialized: dataLen: " + dataLen +
        " parityLen: " + parityLen + " stripeIdxToRack: " + stripeIdxToRack +
        " stripeIdxToNodeInRack: " + stripeIdxToNodeInRack);
    /* Added by RH Jul 26th, 2015 ends */
  }
      ...
      switch (info.type) {
        ...
        case SOURCE:
          ...
          LOG.info("debug info: blockIndex: " + blockIndex + " nodeIndex: " + nodeIdx
              + "blkIndexInStripe: " + blkIndexInStripe);
        ...
        case PARITY:
          ...
          LOG.info("debug info: parity stripeIndex: " + stripeIndex + 
              "blockIndex: " + blockIndex + " nodeIndex: " + nodeIdx + indexToNode.get(nodeIdx));
          retVal.add((DatanodeDescriptor)indexToNode.get(nodeIdx));
          return retVal.toArray(new DatanodeDescriptor[retVal.size()]);
          //return super.chooseTarget(
          //  fileName, numOfReplicas, writer, chosenNodes, exclNodes, blocksize);
